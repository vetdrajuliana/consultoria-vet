    ...
    <div className="grid md:grid-cols-3 gap-10 mt-16">
      ...
      <div className="bg-[#f8f8f8] rounded-[30px] overflow-hidden shadow-lg">
        ...
        <div className="p-8">
          ...
          <p className="mt-4 text-gray-700 leading-8">
            Evolução positiva após acompanhamento veterinário e protocolo
      ...
      <div className="bg-[#f8f8f8] rounded-[30px] overflow-hidden shadow-lg">
        <img
          ...
          alt="Antes e depois de tratamento"
          className="w-full h-[280px] object-cover"
        />
        ...
        <div className="p-8">
          ...
          <p className="mt-4 text-gray-700 leading-8">
            Resultado obtido com diagnóstico, manejo correto e acompanhamento
            técnico no campo.
          </p>
        </div>
      </div>
