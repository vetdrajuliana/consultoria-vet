...
function DashboardMock() {
  return (
    <div className="relative mx-auto w-full max-w-[860px]">
      <div className="rounded-t-[30px] border border-white/15 bg-[#171717] p-2.5 shadow-2xl shadow-black/70">
        <div className="overflow-hidden rounded-t-[24px] bg-[#f7f8f6] text-[#10251b]">
          <div className="grid min-h-[430px] grid-cols-[205px_1fr]">
            <aside className="relative overflow-hidden bg-[#052514] p-4 text-white">
              <div
              ...
              <div className="relative z-10 mb-5 flex justify-center">
                <img src="/pecuaria-logo-menu.png" alt="PecuarIA" className="h-20 w-auto" />
              </div>

              {["Painel da Fazenda", "Cadastros", "Rebanho", "Manejos", "Nutricao", "Relatorios"].map((item, index) => (
                <div
                  key={item}
                  className={`relative z-10 mb-1.5 rounded-xl px-4 py-2.5 text-[14px] font-bold ${
            ...
            <section className="p-5">
              <div className="mb-4 flex items-center justify-between gap-4">
                <div>
                  <p className="text-xl font-bold">Bom dia, Juliana!</p>
              ...
              <div
                className="mb-4 overflow-hidden rounded-3xl px-6 py-5 text-white"
                style={{
                  backgroundImage:
              ...
              >
                ...
                <h2 className="mt-1 text-3xl font-bold">Painel da Fazenda</h2>
                <p className="mt-2 max-w-lg text-base leading-6 text-white/90">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={title} className="rounded-2xl border border-green-50 bg-white p-4 text-center shadow-md">
                    <div className="mx-auto mb-2 h-10 w-10 rounded-full bg-green-100" />
                    <p className="text-xl font-bold text-[#10251b]">{title}</p>
              ...
              <div className="mt-4 grid grid-cols-[1fr_1.2fr] gap-3">
                <div className="rounded-2xl border border-green-50 bg-white p-4 shadow-md">
                  <p className="text-lg font-bold">Consumo por lote</p>
                  <p className="mt-2 text-gray-600">Tratos, MS, MN e piquetes.</p>
                  <div className="mt-3 grid h-24 w-24 place-items-center rounded-full border-[12px] border-green-500 text-xl font-black text-green-900">
                    72%
                  </div>
                </div>
                <div className="rounded-2xl border border-green-50 bg-white p-4 shadow-md">
                  <p className="text-lg font-bold">Evolucao do resultado</p>
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#002414] text-white">
      <section className="relative min-h-screen">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-[1780px] flex-col px-6 py-5 md:px-14">
          <header className="flex flex-wrap items-center justify-between gap-6">
            <Link href="/home" className="block">
              <img src="/pecuaria-logo-menu.png" alt="PecuarIA" className="h-20 w-auto md:h-28 xl:h-32" />
            </Link>

            <nav className="hidden items-center gap-10 text-lg font-semibold text-white/90 lg:flex">
          ...
          <div className="grid flex-1 items-center gap-10 py-4 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="max-w-3xl">
              <div className="mb-5 inline-flex rounded-full border border-lime-300/25 bg-white/5 px-5 py-2.5 text-sm font-bold uppercase tracking-wide text-lime-300 md:text-base">
              ...
              <p className="mt-5 max-w-2xl text-xl leading-8 text-white/85 xl:text-2xl xl:leading-9">
              ...
              <div className="mt-6 flex flex-col gap-4 sm:flex-row">
                <Link
                  href="/app"
                  className="flex items-center justify-center gap-5 rounded-xl bg-lime-500 px-9 py-5 text-xl font-bold text-white shadow-xl shadow-lime-900/30 transition hover:bg-lime-400 xl:text-2xl"
                >
                  Area do Cliente
