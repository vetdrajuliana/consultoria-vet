...
db.version(16).stores({
  ...
  leiturasCocho: "++id, loteId, loteNome, data, nota, consumoMn, consumoMs, tratoMs, ajusteMs, createdAt",
  piquetes: "++id, nome, fazenda, lote, area, capacidade, status, createdAt",
  consumosLote: "++id, loteId, loteNumero, piqueteId, piqueteNome, data, percentualPesoVivo, percentualMateriaSeca, quantidadeAnimais, pesoVivoTotal, consumoMsLote, consumoMnLote, tratosPorDia, createdAt",
});
...
db.version(17).stores({
  ...
  leiturasCocho: "++id, loteId, loteNome, data, nota, consumoMn, consumoMs, tratoMs, ajusteMs, createdAt",
  piquetes: "++id, nome, fazenda, lote, area, capacidade, status, createdAt",
  consumosLote: "++id, loteId, loteNumero, piqueteId, piqueteNome, data, percentualPesoVivo, percentualMateriaSeca, quantidadeAnimais, pesoVivoTotal, consumoMsLote, consumoMnLote, tratosPorDia, totalFornecidoMn, totalFornecidoMs, createdAt",
});
